 ...
 * @author rich
 */
public class ClockInExceptionTest extends TestCase {

  public ClockInExceptionTest(String testName) {
    super(testName);
  }
  ...
  public void testClockInException() {
    ClockInException ciex = new ClockInException();
  ...
  public void testClockInExceptionString() {
    ...
    ClockInException ciex = new ClockInException(msg);
